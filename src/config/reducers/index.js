import { UPDATE_HUMAN_POSITION,UPDATE_FRUIT_POSITION,UPDATE_KEYBOARD_ACTION,UPDATE_TILES,UPDATE_SELECTED_FRUIT,UPDATE_FRUIT_COLLECTION,ADD_POINTS_TO_TOTAL,REMOVE_FRUIT_POSITION,UPDATE_GAME_STATUS,RESTART_GAME,UPDATE_TIMER,UPDATE_MATRIX} from "../constants/action-types";
const initialState = {
...
function rootReducer(state = initialState, action) {
  if (action.type === UPDATE_HUMAN_POSITION) {
    ...
    return Object.assign({}, state, {
  	...
  	return Object.assign({},state,{'status':action.payload,'isTimerRunning':false})
  }
  else if(action.type==UPDATE_TIMER){
  	return Object.assign({},state,{'timer':Object.assign({},state.timer,action.payload)})
  }
